...
namespace Smile_Simulation.Infrastructure.Migrations
{
    ...
    [Migration("20250404003952_post_comment_creation")]
    partial class post_comment_creation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Smile_Simulation.Domain.Entities.Comment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Smile_Simulation.Domain.Entities.Like", b =>
                {
                    b.Property<int>("PostId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Smile_Simulation.Domain.Entities.Post", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Smile_Simulation.Domain.Entities.Comment", b =>
                {
                    b.HasOne("Smile_Simulation.Domain.Entities.Post", "Post")
                        .WithMany("Comments")
                        .HasForeignKey("PostId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Smile_Simulation.Domain.Entities.UserApp", "User")
                        .WithMany("Comments")
                        .HasForeignKey("UserId")
            ...
            modelBuilder.Entity("Smile_Simulation.Domain.Entities.Post", b =>
                {
                    b.HasOne("Smile_Simulation.Domain.Entities.UserApp", "Publisher")
                        .WithMany("Posts")
